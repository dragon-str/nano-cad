...
pub use rotor_scene::{
    build_rotor_scene, CAM_BODY, EJECTION_BORE_CLEARANCE_M, HOUSING_BODY, HOUSING_ROLE,
    HOUSING_THICKNESS_M, INTERFACE_CLEARANCE_M, ROD_BODY_FIRST, ROD_COUNT, ROTOR_BODY, ROTOR_FRAME,
    ROTOR_ROLE, SPRING_LENGTH_M, SPRING_THICKNESS_M, SPRING_WIDTH_M,
};
pub use scene::{
